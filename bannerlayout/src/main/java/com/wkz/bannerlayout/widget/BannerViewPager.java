...
public class BannerViewPager extends ViewPager {
    ...
    @NonNull
    public final BannerViewPager setViewTouchMode(boolean b) {
    ...
    @NonNull
    public final BannerViewPager setVertical(boolean vertical) {
     ...
     */
    @NonNull
    public final BannerViewPager setDuration(int duration) {
        try {
    ...
    public BannerViewPager(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
    }
}
